...
final class Patch {
    ...
    static BigDecimal bigDecimal(Object v) {
    ...
    static Integer intVal(Object v) {
        if (v == null) return null;
    ...
    static List<Long> longList(Object v) {
    ...
    static List<TaskOption> options(Object v) {
        if (!(v instanceof List<?> list)) return null;
