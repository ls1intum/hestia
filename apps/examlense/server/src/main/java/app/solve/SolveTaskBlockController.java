...
public class SolveTaskBlockController {

    public record SolveTaskBlockRequest(@NotBlank String task_id) {}

    private final SolveTaskBlockService service;

    public SolveTaskBlockController(SolveTaskBlockService service) {
    ...
    public Map<String, Object> solve(@Valid @RequestBody SolveTaskBlockRequest req, @CurrentUser String userId) {
