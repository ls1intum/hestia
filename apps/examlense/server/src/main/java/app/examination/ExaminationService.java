...
/**
 * Examination-level operations that must be atomic — currently full exam duplication
...
public class ExaminationService {
    ...
    public ExaminationService(ExaminationRepository exams, SectionRepository sections, TaskBlockRepository tasks,
     ...
     */
    @Transactional
    public Examination duplicateExamination(Examination src, String userId, String titleOverride, String solverOverride) {
