...
- **"Admin"**, **"Admin Dashboard"**, **"Feedback Page"** → `src/pages/admin/AdminDashboard.tsx` (route `/admin`). A tabbed dashboard that aggregates internal review data: user feedback, parsing-quality survey responses, and parser performance metrics. Panels live in `src/pages/admin/components/`.
