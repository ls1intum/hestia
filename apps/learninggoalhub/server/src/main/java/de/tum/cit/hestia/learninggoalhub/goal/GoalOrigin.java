 ...
 *   <li>{@code TERMINAL} — a course-level topic the course's source-backed skill outcomes are assigned
 *       to (the root of a competency tree); an abstraction without a source snippet. See
 *       {@code TopicTreeSynthesizer}.</li>
